<template>
    <div class="order"
     v-infinite-scroll="loadMore"
       ...
       <ul class="content">
           <li class="list_li" v-for="(item,c) in liData">
             <div class="title clearfix">
                <h5 class="left">待评价</h5>
                <a class="right price">交易完成</a>
             </div>
             <h5 class="storeName" @click.prevent="goShop(item.storeId)" ><span class="icon-商店 store"></span> {{item.storeName}}</h5>
             <ul class="goods_ul">
               <li class="clearfix" v-for="(item,x) in item.detail4AppList" @click.prevent="goDetail(item.goodId)">
                  <div class="imgbox">
             ...
             <div class="btbox clearfix">
                ...
                <div class="right">
                     ...
                     <span class="bt paybt comBt" @click.prevnet="appraise(c)">评价</span>
                </div>
             </div>
          </li>
